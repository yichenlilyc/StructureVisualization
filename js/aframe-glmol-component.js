      ...
      function GLmol(data) {
        ...
        GLmol.prototype.drawHETATM = function(hetatmMode) {
          ...
          if (hetatmMode == 'stick') {
            ...
            this.drawBondsAsStick(this.modelGroup, hetatm, this.sphereRadius / 2.0, this.cylinderRadius, true, false, 0.3);
          } else if (hetatmMode == 'ballAndStick2') {
            this.drawBondsAsStick(this.modelGroup, hetatm, this.sphereRadius / 2.0, this.cylinderRadius, true, true, 0.3);
          }
        }
